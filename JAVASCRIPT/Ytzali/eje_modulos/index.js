// importar la funcion usando require()
const {multiplicar, dividir, sumar, restar} = require('./utilidad');

//**
// Ejecucion del llamado de la funcion */
...
console.log(`Resultado de la restar de 7-13 ${restar(7,13)}`);
