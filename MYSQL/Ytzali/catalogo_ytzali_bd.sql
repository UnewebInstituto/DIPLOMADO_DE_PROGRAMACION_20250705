...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-09-2025 a las 17:43:15
...
--
-- Base de datos: `catalogo_ytzali_bd`
--
...
CREATE TABLE `calificaciones` (
  ...
  `calificaciones` tinyint(3) UNSIGNED NOT NULL,
...
--
ALTER TABLE `calificaciones`
  ADD CONSTRAINT `calificaciones_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
