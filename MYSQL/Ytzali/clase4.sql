...
create view view_inner_join_ptoveedores2_productos2 as
select proveedores2.nombre as proveedor,
productos2.nombre as producto,
productos2.precio as precio,
productos2.cantidad as existencia
...
--Vista a partir de la consulta inner join
create view view_left_join_ptoveedores2_productos2 as
select proveedores2.nombre as proveedor,
productos2.nombre as producto,
productos2.precio as precio,
productos2.cantidad as existencia
...
--Vista a partir de la consulta inner join
create view view_right_join_ptoveedores2_productos2 as
select proveedores2.nombre as proveedor,
productos2.nombre as producto,
productos2.precio as precio,
productos2.cantidad as existencia
...
--Vista a partir de la vista full join
create view view_full_join_ptoveedores2_productos2 as
select proveedores2.nombre as proveedor,
productos2.nombre as producto,
productos2.precio as precio,
productos2.cantidad as existencia
