...
--
-- Host: localhost    Database: bd_ismael_20250830
-- ------------------------------------------------------
...
INSERT INTO `alumnos` VALUES (1,'barbaea','villasmil'),(2,'ytzali','rodriges'),(3,'AIRON','ORTEGA'),(4,'MOISES','VILLEGAS'),(5,'RICARDO','MOTTA'),(6,'ISMAEL','HERNADEZ'),(7,'DANIEL','ROJAS');
...
INSERT INTO `asignaturas` VALUES (1,'MATEMATICA'),(2,'FISICA'),(3,'QUIMICA'),(4,'CASTELLANO');
...
CREATE TABLE `contactos` (
  ...
  `tlf_cel` varchar(11) DEFAULT NULL,
  `telefono_hab` varchar(11) DEFAULT NULL,
  `telefono_ofic` varchar(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `contactos` VALUES (1,'oscar','perez','chacao','hdhe@gmail.com',NULL,NULL,NULL),(2,'katalina','a?es','valle','kata@gmail.com',NULL,NULL,NULL),(3,'pedro','lozano','catia','pedrol@gmail.com',NULL,NULL,NULL),(4,'laura','gonzales','dos caminos','jh@gmail.com','0234567321','023451235','04124556789');
...
INSERT INTO `productos1` VALUES (17,22,'AIRE ACONDICIONADO',450.75,4),(18,22,'COCINA ELECTRICA',425.00,2),(19,3,'LAVADORA',700.00,6),(20,3,'CONGELADOR',250.75,5),(21,4,'NEVERA',650.25,9),(22,4,'COCINA A GAS',280.75,6),(23,4,'LAVADORA',450.50,5),(24,4,'SECADORA',550.00,5);
...
INSERT INTO `proveedores` VALUES (1,'ge','maracibo','0423766455','uh@gmail.com'),(2,'mabe','apure','0422355649','mabe@gmail.co'),(3,'whirpool','cojedes','04123667689','whir@gmail.com'),(4,'siragon','uuee','04125673348','riragon@gmail.com'),(5,NULL,'AV. ROOSVELT','02128887766','info@nulo.com'),(6,'','AV. VICTORIA','02129998877','info@blanco.com'),(7,'GE','AV. LECUNA','02124431234','info@ge.com'),(8,'MABE','AV. R?MULO GALLEGOS','02122631234','info@mabe.com'),(9,'WHIRPOOL','AV. FRANCISCO DE MIRANDA','02122062140','info@whirpool.com'),(10,'SIRAGON','AV. LIBERTADOR','02127531234','info@sirangon.com');
...
INSERT INTO `proveedores2` VALUES (1,'GE','AV. LECUNA','02124431234','info@query.com'),(2,'MABE','AV. R?MULO GALLEGOS','02122631234','info@mabe.com'),(3,'WHIRPOOL','AV. FRANCISCO DE MIRANDA','02122062140','info@whirpool.com'),(4,'SIRAGON','AV. LIBERTADOR','02127531234','info@sirangon.com'),(5,'Damasco','AV. casanova','02125053123','ihgb@t31.com');
...
-- Dump completed on 2025-09-20 11:48:46
