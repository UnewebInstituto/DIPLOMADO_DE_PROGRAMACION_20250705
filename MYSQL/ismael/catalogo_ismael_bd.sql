...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-09-2025 a las 17:41:30
...
--
-- Base de datos: `catalogo_ismael_bd`
--
...
ALTER TABLE `productos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `categodia_id` (`categoria_id`);
...
--
ALTER TABLE `categoria`
  ADD CONSTRAINT `categoria_ibfk_1` FOREIGN KEY (`id`) REFERENCES `productos` (`categoria_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `etiquetas`
--
ALTER TABLE `etiquetas`
  ADD CONSTRAINT `etiquetas_ibfk_1` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`categoria_id`) ON DELETE CASCADE ON UPDATE CASCADE;
