...
--
-- Host: localhost    Database: bd_barbara_20250830
-- ------------------------------------------------------
...
INSERT INTO `contactos` VALUES (1,'ANA','VAZQUEZ','SANTA FE','av@gmail.com','02125554433',NULL,NULL),(2,'LIBIA','COLS','GUARENAS','lc@gmail.com','02125554433',NULL,NULL),(3,'HENDRINA','MONASTERIOS','LOS VALLES DEL TUY','hm@gmail.com','02125554433',NULL,NULL),(4,'YOLANDA','TORTOZA','CATIA LA MAR','yt@gmail.com','02125554433',NULL,NULL),(5,'LAURA','GONZALEZ','DOS CAMINOS','lg@gmail.com','02121234567','04149876543','02122345678');
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_resumen_marcas` AS select `vista_proveedores_productos`.`producto` AS `MARCA`,min(`vista_proveedores_productos`.`precio`) AS `PRECIO_MINIMO`,max(`vista_proveedores_productos`.`precio`) AS `PRECIO_MAXIMO`,round(avg(`vista_proveedores_productos`.`precio`),2) AS `PRECIO_PROMEDIO` from `vista_proveedores_productos` group by `vista_proveedores_productos`.`proveedor` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-09-20 11:47:44
