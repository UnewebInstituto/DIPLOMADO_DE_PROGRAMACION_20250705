...
--
-- Name: color; Type: TABLE; Schema: transporte; Owner: postgres
--

CREATE TABLE transporte.color (
    id integer NOT NULL,
    nombre character varying(50)
);


ALTER TABLE transporte.color OWNER TO postgres;

--
-- Name: color_id_seq; Type: SEQUENCE; Schema: transporte; Owner: postgres
--

CREATE SEQUENCE transporte.color_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE transporte.color_id_seq OWNER TO postgres;

--
-- Name: color_id_seq; Type: SEQUENCE OWNED BY; Schema: transporte; Owner: postgres
--

ALTER SEQUENCE transporte.color_id_seq OWNED BY transporte.color.id;
...
--
-- Name: color id; Type: DEFAULT; Schema: transporte; Owner: postgres
--

ALTER TABLE ONLY transporte.color ALTER COLUMN id SET DEFAULT nextval('transporte.color_id_seq'::regclass);
...
COPY transporte.choferes (id, nombre, apellido, cedula, numero_licencia, edad) FROM stdin;
...
--
-- Data for Name: color; Type: TABLE DATA; Schema: transporte; Owner: postgres
--

COPY transporte.color (id, nombre) FROM stdin;
1	Rojo
2	Azul
3	Blanco
4	Gris
...
COPY transporte.paradas (id, nombre, ruta_id) FROM stdin;
10	Terminal Principal	1
11	Av. Libertador	1
12	Plaza Central	1
13	Parque Industrial	2
\.
...
COPY transporte.rutas (id, nombre_ruta, parada_id) FROM stdin;
1	Ruta Central	10
...
2	JOHANA	MUJICA DE ROJAS	04149876532	JMM@GMAIL.COM
1	OTTYS JANETH	MENDEZ	04125675645	JM@GMAIL.COM
3	SORGALIM JOSELIN	PEREIRA	04142345689	SP@GMAIL.COM
\.
...
SELECT pg_catalog.setval('transporte.autobuses_id_seq', 103, true);
...
SELECT pg_catalog.setval('transporte.choferes_id_seq', 2, true);


--
-- Name: color_id_seq; Type: SEQUENCE SET; Schema: transporte; Owner: postgres
--

SELECT pg_catalog.setval('transporte.color_id_seq', 3, true);
...
SELECT pg_catalog.setval('transporte.modelos_id_seq', 3, true);
...
SELECT pg_catalog.setval('transporte.paradas_id_seq', 13, true);
...
SELECT pg_catalog.setval('transporte.rutas_id_seq', 2, true);
...
SELECT pg_catalog.setval('transporte.turnos_id_seq', 2, true);
...
--
-- Name: color color_pkey; Type: CONSTRAINT; Schema: transporte; Owner: postgres
--

ALTER TABLE ONLY transporte.color
...
ALTER TABLE ONLY transporte.autobuses
    ADD CONSTRAINT autobuses_color_id_fkey FOREIGN KEY (color_id) REFERENCES transporte.color(id) NOT VALID;


--
-- Name: autobuses autobuses_color_id_fkey1; Type: FK CONSTRAINT; Schema: transporte; Owner: postgres
--

ALTER TABLE ONLY transporte.autobuses
    ADD CONSTRAINT autobuses_color_id_fkey1 FOREIGN KEY (color_id) REFERENCES transporte.color(id) NOT VALID;
...
--
-- Name: autobuses autobuses_marca_id_fkey1; Type: FK CONSTRAINT; Schema: transporte; Owner: postgres
--

ALTER TABLE ONLY transporte.autobuses
    ADD CONSTRAINT autobuses_marca_id_fkey1 FOREIGN KEY (marca_id) REFERENCES transporte.marca(id) NOT VALID;
...
--
-- Name: autobuses autobuses_modelo_id_fkey1; Type: FK CONSTRAINT; Schema: transporte; Owner: postgres
--

ALTER TABLE ONLY transporte.autobuses
    ADD CONSTRAINT autobuses_modelo_id_fkey1 FOREIGN KEY (modelo_id) REFERENCES transporte.modelos(id) NOT VALID;
...
--
-- Name: autobuses_turnos autobuses_turnos_autobus_id_fkey1; Type: FK CONSTRAINT; Schema: transporte; Owner: postgres
--

ALTER TABLE ONLY transporte.autobuses_turnos
    ADD CONSTRAINT autobuses_turnos_autobus_id_fkey1 FOREIGN KEY (autobus_id) REFERENCES transporte.autobuses(id) NOT VALID;
...
--
-- Name: autobuses_turnos autobuses_turnos_turno_id_fkey1; Type: FK CONSTRAINT; Schema: transporte; Owner: postgres
--

ALTER TABLE ONLY transporte.autobuses_turnos
    ADD CONSTRAINT autobuses_turnos_turno_id_fkey1 FOREIGN KEY (turno_id) REFERENCES transporte.turnos(id) NOT VALID;
...
--
-- Name: choferes_autobuses choferes_autobuses_autobus_id_fkey1; Type: FK CONSTRAINT; Schema: transporte; Owner: postgres
--

ALTER TABLE ONLY transporte.choferes_autobuses
    ADD CONSTRAINT choferes_autobuses_autobus_id_fkey1 FOREIGN KEY (autobus_id) REFERENCES transporte.autobuses(id) NOT VALID;
...
--
-- Name: choferes_autobuses choferes_autobuses_chofer_id_fkey1; Type: FK CONSTRAINT; Schema: transporte; Owner: postgres
--

ALTER TABLE ONLY transporte.choferes_autobuses
    ADD CONSTRAINT choferes_autobuses_chofer_id_fkey1 FOREIGN KEY (chofer_id) REFERENCES transporte.choferes(id) NOT VALID;
...
--
-- Name: recorridos recorridos_autobus_id_fkey1; Type: FK CONSTRAINT; Schema: transporte; Owner: postgres
--

ALTER TABLE ONLY transporte.recorridos
    ADD CONSTRAINT recorridos_autobus_id_fkey1 FOREIGN KEY (autobus_id) REFERENCES transporte.autobuses(id) NOT VALID;
...
--
-- Name: recorridos recorridos_ruta_id_fkey1; Type: FK CONSTRAINT; Schema: transporte; Owner: postgres
--

ALTER TABLE ONLY transporte.recorridos
    ADD CONSTRAINT recorridos_ruta_id_fkey1 FOREIGN KEY (ruta_id) REFERENCES transporte.rutas(id) NOT VALID;
...
--
-- Name: rutas rutas_parada_id_fkey1; Type: FK CONSTRAINT; Schema: transporte; Owner: postgres
--

ALTER TABLE ONLY transporte.rutas
    ADD CONSTRAINT rutas_parada_id_fkey1 FOREIGN KEY (parada_id) REFERENCES transporte.paradas(id) NOT VALID;
