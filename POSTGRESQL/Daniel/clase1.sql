...
--SE SUGIERE QUE LOS NOMBRES DE TABLAS SEAN EN PLURAR
...
-- Al presentarce una asociacion entre tablas, la existecia de registros 
--en la tablas dependientes (hijas) se basa en la creacion de valores 
...
VALUES
('GENERAL ELECTRIC', 'AV. LECUNA', '+584125897896', 'info@ge.com'),
('SIRAGON', 'AV. FUERZAS ARMADAS', '+584126547845', 'info@siragon.com'),
('SAMSUNG', 'AV. SAN MARTIN', '+584223216598', 'info@samsung.com'),
('LENOVO', 'CANDELARIA', '+584125987896', 'info@lenovo.com');
...
--combinacion d ambas tablas en una consulta 
...
select proveedores.nombre,
       ...
       where proveedores_id = productos.proveedor_id;
