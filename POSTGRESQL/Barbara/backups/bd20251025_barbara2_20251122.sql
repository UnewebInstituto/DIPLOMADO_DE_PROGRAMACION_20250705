...
CREATE TABLE transporte.choferes (
    ...
    no_licencia character varying(9),
    edad smallint
);
...
COPY transporte.choferes (id, nombre, apellido, cedula, no_licencia, edad) FROM stdin;
...
10	Terminal Principal	\N
11	Av. Libertador	\N
12	Plaza Central	\N
13	Parque Industrial	\N
\.
...
COPY transporte.recorridos (ruta_id, autobus_id) FROM stdin;
1	101
1	102
2	103
2	102
...
COPY transporte.rutas (id, nombre, paradas_id) FROM stdin;
1	Ruta Central	10
...
2	NELLY	CONTRERAS	04147654321	NC@GMAIL.COM
3	NELLY DEL CARMEN	TORTOZA	04149874561	YT@GMAIL.COM
\.
...
--
-- Name: rutas rutas_paradas_id_fkey; Type: FK CONSTRAINT; Schema: transporte; Owner: postgres
--

ALTER TABLE ONLY transporte.rutas
    ADD CONSTRAINT rutas_paradas_id_fkey FOREIGN KEY (paradas_id) REFERENCES transporte.paradas(id) NOT VALID;
