...
1	ANA	VASQUEZ	04141234567	AV@MAIL.COM
2	NELLY	CONTRERAS	04149876543	NC@MAIL.COM
3	NELLY DEL CARMEN	TORTOZA	0414563254	YT@MAIL.COM
\.
...
--
-- Name: autobuses autobuses_color id_fkey; Type: FK CONSTRAINT; Schema: transporte; Owner: postgres
--

ALTER TABLE ONLY transporte.autobuses
    ADD CONSTRAINT "autobuses_color id_fkey" FOREIGN KEY (color_id) REFERENCES transporte.colores(id) NOT VALID;
