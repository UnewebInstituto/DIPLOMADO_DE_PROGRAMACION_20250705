...
ALTER SEQUENCE transporte.modelo_id_seq OWNED BY transporte.modelos.id;
...
ALTER TABLE ONLY transporte.modelos ALTER COLUMN id SET DEFAULT nextval('transporte.modelo_id_seq'::regclass);
...
2	NELLY	CONTRERAS	04131234567	NC@GMAIL.COM
3	NELLY DEL CARMEN	TORTOZA	04241234567	YT@GMAIL.COM
\.
...
--
-- Name: modelos modelo_pkey; Type: CONSTRAINT; Schema: transporte; Owner: postgres
--
