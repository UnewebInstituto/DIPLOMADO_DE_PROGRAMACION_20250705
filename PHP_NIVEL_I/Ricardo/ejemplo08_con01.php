<?php
    ...
    try {
        ...
        if ($cantidad > 0){
            ...
            <?php
                $mensaje = "Consulta realizada con éxito para la cédula " . $cedula;
                $severidad = 1;
        }else{
            // No se encontró registro que coíncida
            $mensaje = "No se encontraron datos personales que coíncidan con el número de cédula " . $cedula;$mensaje = "No se encontraron datos personales que coíncidan con el número de cédula " . $cedula;
            $severidad = 3;
        }
        mysqli_close($enlace);
