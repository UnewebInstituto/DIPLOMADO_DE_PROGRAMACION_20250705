...
<div class="mb-3 mt-3 col">
    ...
    <div class="input-group">
        ...
        <input type="text" class="form-control" id="numero" placeholder="Ingrese la cédula de identidad" name="numero" require>
    </div>
</div>
...
<div class="mb-3">
 ...
 <div class="mb-3">
    ...
    <input type="text" class="form-control" id="telefono" placeholder="Ingrese su numero de telefono" name="telefono" require>
  </div>

  <div class="mb-3">
    <label for="correoelectronico" class="form-label">Correo Electronico:</label>
    <input type="email" class="form-control" id="correoelectronico" placeholder="Ingrese su correo electronico" name="correoelectronico" require>
  </div>
  <div class="mb-3">
