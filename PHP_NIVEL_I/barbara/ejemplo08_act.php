...
<?php
    ...
    try {
        ...
        if ($cantidad > 0){
            ...
            ?>
            <h2>Actualizar registro de Personas</h2>
                        ...
                        <?php
                            while ($datos = mysqli_fetch_array($resultado)){
                                echo "<tr>";
                                    ...
                                    echo "<td scope='row'><a href='./ejemplo08_act01.php?id={$datos['id']}' 
                                    title='Actualizar este registro'><img src='./img/actualizar.png'></a></td>";
                                echo "</tr>";
                            }
