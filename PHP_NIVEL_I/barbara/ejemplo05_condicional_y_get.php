...
if (isset($_GET['a']) && isset($_GET['b']) && isset($_GET['c'])){
    ...
    echo "<h3>Por ejemplo:<br>http://localhost:8004/ejemplo05_condicional_y_get.php?a=valor&b=valor&c=valor</h3>";
    if (!isset($_GET['a'])){
        echo "Faltó 'a'<br>";
    }
    if (!isset($_GET['b'])){
...
/*
Casos de prueba:
localhost:8004/ejemplo05_condicional_y_get.php?a=0&b=1&c=1

localhost:8004/ejemplo05_condicional_y_get.php?a=1&b=1&c=1

localhost:8004/ejemplo05_condicional_y_get.php?a=1&b=4&c=1
