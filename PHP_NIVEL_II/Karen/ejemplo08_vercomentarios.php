...
<?php
    ...
    $sql = "SELECT * FROM comentarios ORDER BY fecha, hora DESC WHERE id_tema = '$_GET[id_tema]'";
    ...
    try {
        ...
        if ($cantidad > 0){
        # Se encontraron comentarios registrados
        ?>
                        ...
                        <?php
                            while ($datos = mysqli_fetch_array($resultado)){
                                echo "<tr>";
                                    ...
                                    echo "<td class='text-center' scope='row'><a title='Ver comentarios' href='./ejemplo08_vercomentarios.php?id_tema={$datos['id']}'>{$cantidad_comentarios['cnt_comentarios']}</a></td>";
                                echo "</tr>";
                            }
