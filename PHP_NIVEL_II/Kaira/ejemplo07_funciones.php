<?php
    ...
    echo "<br><br>";
    echo "<div style='color:purple'>función resto_dividir()</div>";
    echo "Resultado con parámetros (argumentos) por referencia:";
    echo dividir($a, $b);
    echo "<br>"; 
    echo "Resultado con parámetros (argumentos) por valor division exacta:";
    echo dividir(8,2);
    echo "<br>";
    echo "Resultado con parámetros (argumentos) por valor division inexacta:";
    echo dividir(5,8);
    echo "<br>";  
    echo "Resultado con parámetros (argumentos) por valor división por cero:";
