<?php
    ...
    if ($cantidad > 0) {
        ...
        while ($data = pg_fetch_array($resultado)) {
            ...
            $b = $b + 1; //Se aumenta el indice de la columna en 1 
            if ($b == 4) {
                $a =  $a + 1;
                $b = 1;
                }
        ...
        //Verificar la cantidad de articulos para presentar en el catalogo
        if ($cantidad >= 3) {
            $condicion = 3;
        }else{
            $condicion = $cantidad;
    ...
    $_GET['severidad'] = 3;
    $_GET['mensaje'] = "No hay productos registrados en el sistema";
    }
