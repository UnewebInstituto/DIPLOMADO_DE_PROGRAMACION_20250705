...
<form action="./login01.php" method="POST">
  ...
  <div>
    <div>
        <label for="clave" class="block mb-2 mt-2 text-sm font-medium text-gray-900">Clave secreta</label>
