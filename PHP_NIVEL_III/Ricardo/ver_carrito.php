    ...
    if (!$_SESSION['activo']){
        ...
        if ($cantidad == 0){
            ...
            while ($data = pg_fetch_array($resultado)){
                ...
                echo "<td class='border border-gray-200 text-center'><input type='number' name='cantidad' min='1' required></td>";
                ...
                echo "<input type='hidden' name='id_producto[]' value={$data['id_producto']} multiple>";
                echo "<input type='hidden' name='precio[]' value='{$data['precio']}' multiple>";
                echo "</tr>";
            }
            echo "</table>";
