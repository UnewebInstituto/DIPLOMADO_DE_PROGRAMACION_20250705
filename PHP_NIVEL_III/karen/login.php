...
<div class="text-center">
    <h2 class="text-xl">Validar sesión</h2>
...
<form action="./login01.php" method="POST">
  <div>
    ...
    <div>
        ...
        <div id="emailHelp" class="mt-4 mb-4 text-xs">No vamos a compartir su correo electrónico.</div>
    </div>
  ...
  <div>
    ...
    <div>
        <label for="clave" class="block mb-2 text-sm font-medium text-gray-900"class="block mb-2 text-sm font-medium text-gray-900">Clave secreta</label>
        ...
        <div class="text-sm mt-4">
            <p>¿No posee usuario? Haga click <a href="./registrarse.php" class='text-blue-600 font-medium hover:text-blue-800 underline-offset-4 hover:underline transition-all duration-200'>Aqui</a> para registrarse</p><br>
        </div>
