#Ejemplo 01 Estructura de Control, Casi Condicionales
#Declaraión de una dependencia
...
while True:
    ...
    if a == 0:
        ...
        if subRadical < 0:
            mensaje = 'Error: Expresión sub Radical no puede ser negátiva'
        else:
    ...
    #print(mensaje)
    continuar = input('¿Desea realizar un nuevo cálculo (S/N)?')
