...
while True:
    ...
    match operacion:
        case '+':
            resultado = modulo_calculadora.sumar(n1, n2)
        case '-':
            resultado = modulo_calculadora.restar(n1, n2)
        case '*':
            resultado = modulo_calculadora.multiplicar(n1, n2)
        case '/':
            resultado = modulo_calculadora.dividir(n1, n2)
