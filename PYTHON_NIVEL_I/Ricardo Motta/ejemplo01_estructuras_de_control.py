...
# Declararion de una dependencia
import math #Necesario para usar funciones matematicas
while True:
    ...
    if a == 0:
        mensaje = 'Valor de a, debe ser diferente de 0'
        print(mensaje)
    else:
        while True:
            try:
    ...
    #print(mensaje)
    continuar = input('Desea efectuar un nuevo calculo(S/N):?')
