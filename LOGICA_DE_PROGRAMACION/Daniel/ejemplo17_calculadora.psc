...
Funcion potencia <- calcular_potencia(arg_base,arg_expo)
	...
	calculo <- 1
	contador <- 0
	// TRUNC(), se emplea la funci?n para s?lo reconocer
...
Funcion condicion_de_error <- error(arg_n1,arg_n2)
	...
	condicion_de_error <- 'Operaci?n no definida para la calculadora'
FinFuncion
...
Algoritmo Ejemplo17_Calculadora
	...
	Mientras Mayusculas(continuar) = 'S' Hacer
		...
		leer n2
		escribir 'Ingrese el n?mero de la operaci?n a realizar'
		escribir '1:Sumar'
		escribir '2:Restar'
